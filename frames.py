...
class Frames:
    ...
    def __init__(self, mainObj, MainWin, wWidth, wHeight, function, Object, xAxis=10, yAxis=10):
        ...
        self.MainWindow.title("Brain Cancer Detection")
        ...
        self.btnView = tkinter.Button(self.winFrame, text="Prediction", width=8, command=lambda: self.NextWindow(self.method))
        self.btnView.place(x=800, y=600)
